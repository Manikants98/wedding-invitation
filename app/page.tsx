...
export default function Home() {
  return (
    <main className="min-h-screen bg-cream relative overflow-x-hidden">
      ...
      <Mandala className="fixed -left-20 top-20 w-[500px] h-[500px] text-gold/10" opacity={0.1} />
      <Mandala className="fixed -right-20 bottom-20 w-[600px] h-[600px] text-maroon/5" opacity={0.05} />
