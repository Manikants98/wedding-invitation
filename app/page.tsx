...
import PrintableInvitation from "@/components/PrintableInvitation";
...
export default function Home() {
  return (
    <main className="min-h-screen bg-cream relative overflow-x-hidden">
      ...
      />
      <div className="fixed inset-0 bg-gradient-to-b from-cream via-transparent to-cream opacity-80 pointer-events-none z-0" />

      {/* Rotating Mandala Background */}
      <Mandala
        className="fixed -left-20 top-20 w-[500px] h-[500px] text-gold/10"
        opacity={0.1}
      />
      <Mandala
        className="fixed -right-20 bottom-20 w-[600px] h-[600px] text-maroon/5"
        opacity={0.05}
      />
      ...
      <div
        id="invitation-card"
        className="relative z-10 w-full md:max-w-4xl mx-auto min-h-screen shadow-2xl bg-white/40 backdrop-blur-md border-[6px] border-double border-gold/30 my-0 md:my-8 rounded-none md:rounded-xl overflow-hidden"
      >
        {/* Corner Ornaments */}
